...
variantfile='/scratch/alpine/aassante@xsede.org/alexis/analysis/exome_SR/variantcalled.csv' ## That CSV file with sample data needs to exist
pipeoutdir="/scratch/alpine/aassante@xsede.org/alexis/analysis/exome_SR/sarekRUN_humanonly"
...
nextflow run "$sarek381" -profile curc_alpine -ansi-log false \
	...
	--tools vep,snpeff \
        --outdir "$pipeoutdir" \
        --multiqc_title 381_WES_SR_multiqc \
	--intervals "/scratch/alpine/aassante@xsede.org/alexis/analysis/exome_SR/ptargets.bed" \
	-resume
